...
namespace ScoreTracker
{
    ...
    public class Plugin
    {
        ...
        // public const string HarmonyId = "com.github.YourGitHub.ScoreTracker";
        // internal static readonly HarmonyLib.Harmony harmony = new HarmonyLib.Harmony(HarmonyId);
        public static BeatSaverSharp.BeatSaver BeatSaver;

        internal static Plugin Instance { get; private set; }
        internal static IPALogger Log { get; private set; }
        internal static ScoreTrackerController PluginController { get { return ScoreTrackerController.Instance; } }
        ...
        */
        ...
        {
            new GameObject("ScoreTrackerController").AddComponent<ScoreTrackerController>();
            //ApplyHarmonyPatches();
        }
